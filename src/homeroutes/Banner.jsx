...
// https://i.ibb.co/dMhpYG3/Mihad-bc-03.png
    ...
    return (
      <div className="flex flex-row-reverse items-center justify-center gap-40 pt-20 bg-emerald-200 px-10 bg-gradient-to-r from-emerald-600 to-transparent rounded-b-lg h-[700px]">
        <div className="w-3/6">
          <img
            className=" "
        ...
        <div className="w-[60%]">
          ...
          <p className="text-5xl font-bold text-black pt-3 tracking-wide">
            <TypeAnimation
          ...
          <p className="pt-3 font-medium tracking-widest text-lg">
          ...
          <p className="flex items-center gap-4 pt-5 text-black">
            <a

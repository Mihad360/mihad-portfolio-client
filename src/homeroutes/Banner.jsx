...
const Banner = () => {
  return (
    <div className="flex flex-row-reverse items-center justify-center gap-40 pt-20 px-10 bg-emerald-200 bg-gradient-to-r from-emerald-600 to-transparent dark:bg-neutral-900 dark:bg-none rounded-b-lg h-[700px]">
      <div className="w-3/6">
        <img
          className=""
      ...
      <div className="w-[60%]">
        ...
        <p className="text-5xl font-bold text-black pt-3 tracking-wide dark:text-white">
          <TypeAnimation
        ...
        <p className="text-2xl font-bold pt-3 dark:text-white">
          <TypeAnimation
            sequence={[
              "Front-end Developer",
              1000,
        ...
        <p className="pt-3 font-medium tracking-widest text-lg text-black dark:text-gray-300">
        ...
        <p className="flex items-center gap-4 pt-5 text-black dark:text-white">
          <a
